...
def animate(i, ser, now, xs_roll, xs_pitch, xs_yaw, ys_x, ys_y, ys_z):
...
if serial:    
    ...
    ani = animation.FuncAnimation(fig, animate, fargs=(ser, now, xs_roll, xs_pitch, xs_yaw, ys_x, ys_y, ys_z), interval=1, blit=True)
    plt.show()
else:
    ser = 0
    # setup plot to call animate() funciton periodically
